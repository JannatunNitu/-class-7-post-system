...
<body>
    ...
    <nav class="navbar navbar-expand-lg" style="padding: 30px 0 50px 0;">
      <div class="container">
        <a class="navbar-brand" href="#" style=" font-size:40px; font-weight:700; color:#157347;">Post System</a>
        ...
        <div class="collapse navbar-collapse " id="menu">
          <ul class="navbar-nav m-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class=" btn btn-success" aria-current="page" href="#" style="margin-right: 30px; font-size:30px;">Add post</a>
            </li>
            <li class="nav-item">
              <a class="btn btn-success" href="#" style="font-size:30px;">All post</a>
            </li>
          </ul>
